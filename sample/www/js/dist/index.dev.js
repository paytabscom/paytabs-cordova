...
function onSuccess(result) {
  ...
  } else if (result["status"] == "error") {// Handle error here the code and message.
  } else if (result["status"] == "event") {// Handle events here.
  }
}
...
function payWithCard() {
  ...
  configuration.showShippingInfo = true; // Set samsung token to support SamsungPay 
  // configuration.samsungToken = "samsung token"

  var billingDetails = new cordova.plugins.CordovaPaymentPlugin.PaymentSDKBillingDetails(name = "John Smith", email = "email@domain.com", phone = "+9731111111", addressLine = "Flat 1,Building 123, Road 2345", city = "Dubai", state = "Dubai", countryCode = "AE", zip = "1234");
...
function payWithSamsungPay() {
  ...
  configuration.merchantName = "Flowers Store";
  configuration.amount = 20;
  configuration.screenTitle = "Pay with Card"; // Set samsung token to support SamsungPay 
...
function payWithSTCPay() {
  ...
  var billingDetails = new cordova.plugins.CordovaPaymentPlugin.PaymentSDKBillingDetails(name = "Mohamed Adly", email = "email@domain.com", phone = "96611111111", addressLine = "Flat 1,Building 123, Road 2345", city = "Dubai", state = "Dubai", countryCode = "AE", zip = "1234");
  configuration.billingDetails = billingDetails;
